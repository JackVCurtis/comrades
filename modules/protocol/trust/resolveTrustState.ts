import type { EndorsementRecord } from '@/modules/protocol/records';
...
export {
    ...
    DEFAULT_TENTATIVE_SCORE_THRESHOLD, DEFAULT_TRUST_RESOLUTION_POLICY, DEFAULT_VERIFIED_SCORE_THRESHOLD
};
