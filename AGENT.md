...
- MUST Follow the explicit TDD cycle for every behavior change or bug fix:
...
- SHOULD prefer **DRY (Don't Repeat Yourself)** and **SOLID** design principles to improve maintainability.
